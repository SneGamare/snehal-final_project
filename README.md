    ...
    public ConsumerConfiguration<DtdGamBusinessEvent> gamDlqKafka(
        ...
        return ConsumerConfiguration.<DtdGamBusinessEvent>builder()
                ...
                .dlqConfig(ConsumerConfiguration.DlqConfiguration.<DtdGamBusinessEvent>builder()
                        .dlqTopic("dtd-gam-dlq")
                        .bootstrapServers("b-1.mskplutusdev01.n5cllq.c2.kafka.ap-south-1.amazonaws.com:9092,b-2.mskplutusdev01.n5cllq.c2.kafka.ap-south-1.amazonaws.com:9092")
                        .valueSerializer(PlutusAvroSerializer.class)
